		...
		<div class="services">
			...
			<div class="w3ls_service_grids">
				<div class="col-md-5 w3ls_service_grid_left">
					<h4>custmer satisfaction is our satisfaction</h4>
					<p>we train our employees with heigh standards and our servicess are customer friendly.</p>
				</div>
			...
			<div class="w3ls_service_grids1">
				...
				<div class="col-md-6 w3ls_service_grids1_right">
					<ul>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>fast dilivery</li>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>24/7 customer support</li>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>trained staff</li>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>from the top brands</li>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>directly from the farm</li>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>exclent feedback</li>
					</ul>
